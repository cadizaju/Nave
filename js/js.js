...
function start() { // Inicio da função start()
	...
	$("#inicio").hide(); // Só é possível usar " $ " por que estamos utilizando o JQuery
	...
	if (colisao6.length>0) { /* colisao inimigo 2 com amigo*/
	perdidos++;    
	...
	div.animate({width:400, heygth: 600, opacity:0}, "slow");
